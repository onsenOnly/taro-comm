...
import BestCommentList from '../../components/best_comment_list'
      ...
      <View className='my-msg-page'>
        {
          postArr.length !== 0 ?
            <View className='comment-recommend'>
              <BestCommentList listData={postArr} />
            </View> :
            <View  className='comment-recommend-not-data'>目前尚未有通过的精彩留言，赶紧抢座吧！</View>
        }
      </View>
    )
  }
